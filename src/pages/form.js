      ...
      fields: [
        {
          ...
          query: {
            transformers: ["cwp:ins:transformer::post:dssat_transformer:v1.0"],
          },
          location: {
            type: "Feature",
            geometry: {
          ...
          planting: {
            date: plantingDate+"T00:00:00Z", //moment(plantingDate, 'YYYY-MM-DD').utc().format("YYYY-MM-DDT00.00.00Z"),
            density: {
              value: 7,
              unit: "plants/m2",
            },
    ...
    <Form>
      ...
      <FormItem label="Planting Date">
        <DatePicker
          ...
          value={plantingDate ? moment(plantingDate, "YYYY-MM-DD") : undefined}
          format={"YYYY-MM-DD"}
        />
      </FormItem>
